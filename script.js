...
class TeamSpiritSimulator {
    constructor(coachLeadership, psychologistLevel = 0, decayMethod = 'lokes') {
        ...
        this.riseRates = {
            7: { 0: 1/10, 1: 1/9,  2: 1/8,  3: 1/11, 4: 1/15 },
            6: { 0: 1/10, 1: 1/9,  2: 1/8,  3: 1/11, 4: 1/15 },
            5: { 0: 1/12, 1: 1/11, 2: 1/10, 3: 1/14, 4: 1/20 },
            4: { 0: 1/16, 1: 1/15, 2: 1/13, 3: 1/19, 4: 1/25 },
            3: { 0: 1/23, 1: 1/22, 2: 1/20, 3: 1/30, 4: 1/35 },
            2: { 0: 1/50, 1: 1/45, 2: 1/40, 3: 1/60, 4: 1/65 },
